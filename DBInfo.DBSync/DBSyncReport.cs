...
namespace DBInfo.DBSync
{
    ...
    protected override string ScriptColunaExcluida(Column Coluna, string NomeTabela)
		...
		private string ScriptAlteracaoColumnsPrimaryKey(System.Collections.ArrayList pkAtual, System.Collections.ArrayList pkNova, string NomeTabela)
		{
			string relatorioAlteracao = string.Empty;						
    ...
    private string ScriptColunaPrimaryKeyRemovida(Column pk, string NomeTabela)
		...
		private string ScriptAlteracaoColumnsIndice(System.Collections.ArrayList ixAtual, System.Collections.ArrayList ixNova, string NomeTabela)
		{
			string relatorioAlteracao = string.Empty;						
    ...
    private string ScriptAlteracaoCheckConstraint(CheckConstraint ccAtual, CheckConstraint ccNova, string NomeTabela)
		{
			...
			if(ccAtual.Expressao != ccNova.Expressao)
				relatorioAlteracao += "   Expressão: " + ccNova.Expressao + Environment.NewLine;

			if(relatorioAlteracao.Length > 0)
				relatorioAlteracao = "Alteração CheckConstraint: " + ccAtual.Nome + Environment.NewLine + relatorioAlteracao;
    ...
    private string ScriptInclusaoCheckConstraint(CheckConstraint cc, string NomeTabelaOrigem)
		{
			string relatorioAlteracao = "Inclusão CheckConstraint - " + cc.Nome + Environment.NewLine;			
			relatorioAlteracao += "   Expressão: " + cc.Expressao + Environment.NewLine;
			return relatorioAlteracao;
		}
    ...
    private string ScriptCheckConstraintExcluida(CheckConstraint cc, string TableName)
		{
			return "Excluir CheckConstraint - " + cc.Nome + Environment.NewLine;				
		}
